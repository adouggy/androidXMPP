...
public class XMPPConnection extends Connection {
    ...
    private void setConnected(boolean isConnected) {
    	//if connected changes, broadcast to activity by NotificationService.connectionHandler
    	if(connected != isConnected) {
    		System.out.println("connection status changed: " + connected + "->" + isConnected);
	    	NotificationService.sendConnectionStatus(isConnected);    	
    	}
