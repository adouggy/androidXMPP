...
//            running = false;
            if (!reconnection.isAlive()/* && isConnectable()*/) {
        ...
        public void run() {
            ...
            if (!xmppManager.isConnected()) {
                ...
                ConnectionConfiguration connConfig = new ConnectionConfiguration(
                        xmppHost, xmppPort);
                System.out.println( ">>>Host:" + xmppHost );
                System.out.println( ">>>Port:" + xmppPort );
